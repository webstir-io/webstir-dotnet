...
public class SourceMapGenerator
{
    ...
    public void AddMapping(ModuleInfo module)
    {
        ...
        _mappings.Add(new MappingSegment
        {
    ...
    private string EncodeMappings()
    {
        ...
        List<MappingSegment> sorted = [.. _mappings.OrderBy(m => m.GeneratedLine).ThenBy(m => m.GeneratedColumn)];
        ...
        foreach (MappingSegment segment in sorted)
        {
