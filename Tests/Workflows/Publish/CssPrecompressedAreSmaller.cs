...
public sealed class CssPrecompressedAreSmaller : ITestCase
{
    ...
    public void Execute(TestCaseContext context)
    {
        ...
        Assert.LessThan(br.Length, original.Length, "Brotli output should be smaller than the original CSS");
        Assert.LessThan(gz.Length, original.Length, "Gzip output should be smaller than the original CSS");
    }
}
