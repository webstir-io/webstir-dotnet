...
{
    public string Name => "HTML publish strips comments while keeping attribute semantics";
    ...
    public void Execute(TestCaseContext context)
    {
        ...
        Assert.DoesNotContain("<!-- body comment should be removed -->", distHtml, "Body comment should be stripped");
