...
FRONTEND_REGISTRY_SPEC="${WEBSTIR_FRONTEND_REGISTRY_SPEC:-}"
...
node "${ROOT_DIR}/utilities/update-package-manifest.js" "${LOCAL_MANIFEST_PATH}" "@webstir/frontend" "${VERSION}" "${REPO_TARBALL_PATH}" "${HASH}" "${FRONTEND_REGISTRY_SPEC}"
