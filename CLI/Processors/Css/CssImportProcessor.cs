...
public static class CssImportProcessor
{
    ...
    /// </summary>
    public static string ProcessForBuild(string cssContent, string sourceFilePath, string outputPath, bool releaseMode = false)
    {
        ...
        return ImportRegex.Replace(cssContent, match =>
        {
            ...
            var resolvedPath = CssPathResolver.ResolvePath(importPath, sourceDir);
            ...
            if (!File.Exists(importedOutputPath))
            {
                ...
                importedContent = ProcessForBuild(importedContent, resolvedPath, importedOutputPath, releaseMode);
    ...
    /// </summary>
    public static string ProcessForPublish(string cssContent, string sourceFilePath, HashSet<string>? processedFiles = null)
    {
        ...
        return ImportRegex.Replace(cssContent, match =>
        {
            ...
            var importedContent = File.ReadAllText(resolvedPath);
            importedContent = ProcessForPublish(importedContent, resolvedPath, processedFiles);
